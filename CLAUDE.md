...
**bgl_yatai** *(Levels 3–4 — japanischer Strassenstand unterm offenen Himmel, hell und einladend):*
Cute kawaii flat illustration of a Japanese yatai street food stall seen from the front on a bright clear day, a dark navy noren curtain with a simple white circular mon crest draped across the very top edge, a cheerful red and cream striped awning banner just below it spanning the full width, the large center area showing only a smooth pale blue sky with two or three very subtle flat white clouds high up and nothing else, a warm honey-toned wooden yatai counter with softly rounded corners running across the bottom edge, a few tiny ceramic jars and one small potted plant sitting on the counter surface at its far corners, gentle flat pastel green hill silhouettes peeking in from the lower left and right edges only, bright even morning lighting with no glowing lights and no shadows, all decorative details pushed strictly to the top and bottom edges with the wide middle completely open, no lanterns anywhere, no food items anywhere in the scene, kawaii flat illustration style with clean dark-brown outlines and solid flat pastel fills, bright warm pastel color palette matching the sunny mood, tall portrait 9:16, no text, no watermark, 8k resolution
...
**bgl_tatami** *(Bento-Sammel-Ansicht — Backdrop hinter dem Panel):*
Cute kawaii flat illustration of a warm Japanese room interior seen straight from above as a full-screen backdrop, a large woven tatami mat surface in soft warm beige-green filling the whole frame with its subtle regular weave texture, two delicate sakura branches with small pale pink blossoms resting in the upper left and lower right corners only, one tiny folded pastel cloth napkin at the lower left edge, the large center area showing only the plain smooth tatami surface with nothing on it, soft warm indoor lighting with gentle darker vignette toward all four corners, cozy calm atmosphere, all decorative details pushed strictly to the corners and edges, no objects in the center area, no food items anywhere in the scene, kawaii flat illustration style with clean dark-brown outlines and solid flat warm fills, warm muted earthy color palette, tall portrait 9:16, no text, no watermark, 8k resolution
...
**bento_box** *(offene Lackbox mit vier leeren Faechern):*
A single traditional Japanese lacquered bento box seen from a slight top-down three-quarter angle, the lid removed and not visible, a softly rounded rectangular body wider than tall in deep glossy black-brown lacquer, the interior divided by raised lacquer dividers into four equal empty compartments arranged in a two by two grid filling almost the whole box, each compartment a clean flat dark surface with nothing inside, a thin warm gold trim line running along the outer rim, clean dark-brown outline of uniform weight, front-facing compact proportions with generous even padding on all sides, pure solid magenta background (#FF00FF), zero shadow, sharp clean silhouette edges, 8k resolution
