...
Cute kawaii flat illustration of a Japanese cherry blossom hanami outdoor scene seen from the front, a soft pastel blue sky filling most of the upper frame with two small rounded white clouds, delicate pink sakura branches with clusters of simple five-petal cherry blossoms framing the upper left and upper right corners only, a gentle rolling bright green grass hill across the bottom fifth, a few tiny scattered pink petals floating loosely in the air, the large center area deliberately plain and empty showing only the soft blue sky with absolutely no objects, all decorative details confined to the very top corners and the bottom edge only, no food items or characters anywhere in the scene, kawaii flat illustration style with clean dark-brown outlines and solid flat pastel fills, fresh bright spring color palette, tall portrait 9:16, no text, no watermark, 8k resolution
